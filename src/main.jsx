...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        path: '/alltoys',
        element: <AllToys />,
        loader: () => fetch('https://assignment-11-server-side-lovat.vercel.app/addatoy')
      },
      {
        path: '/addatoy',
      ...
      },
      {
        path: '/updateatoy/:id',
        element: <UpdateAToy/>,
        loader: ({params}) => fetch(`https://assignment-11-server-side-lovat.vercel.app/addatoy/${params.id}`) 
      },
      {
        path: '/blogs',
        element: <Blogs />
      ...
      },
      {
        ...
        loader: ({params}) => fetch(`https://assignment-11-server-side-lovat.vercel.app/tabs/${params.id}`)
      },
      {
        path: '/truck/:id',
